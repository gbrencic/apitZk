 ...
 * @author davedes
 */
public class ShaderLesson2 extends BasicGame {
    private Image logo;


    public static void main(String[] args) throws SlickException {
        new AppGameContainer(new ShaderLesson2(), 800, 600, false).start();
    }

    public ShaderLesson2() {
        super("Shader Lesson 2");
    }
    ...
    public void init(GameContainer container) throws SlickException {
        ...
        try {
            ...
            final String VERT = "common/resources/shaders/lw_lesson2.vert";
            final String FRAG = "common/resources/shaders/lw_lesson2.frag";
