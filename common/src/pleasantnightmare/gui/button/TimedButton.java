 ...
 */
public class TimedButton extends Body implements Button, Animatable {
    ...
    public TimedButton(String id, float x, float y, Image u, Image d, int delay) throws SlickException {
