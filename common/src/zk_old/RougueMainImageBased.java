...
public class RougueMainImageBased {
...
/*
        ...
        //Create Buildings
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(18, 20)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(1, 18, 20)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(18, 21)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(1, 18, 21)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(18, 22)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(19, 20)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(1, 19, 20)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(20, 20)));
        stage.addEntityBeforeUpdate(new DestructbleWall(new Coordinates(21, 20)));
*//*
