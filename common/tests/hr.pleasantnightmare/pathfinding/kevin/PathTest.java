...
public class PathTest extends JFrame {
    ...
    public PathTest() {
        ...
        try {
            tiles[GameMap.TREES] = ImageIO.read(getResource("kev/trees.png"));
            tiles[GameMap.GRASS] = ImageIO.read(getResource("kev/grass.png"));
            tiles[GameMap.WATER] = ImageIO.read(getResource("kev/water.png"));
            tiles[GameMap.TANK] = ImageIO.read(getResource("kev/tank.png"));
            tiles[GameMap.PLANE] = ImageIO.read(getResource("kev/plane.png"));
            tiles[GameMap.BOAT] = ImageIO.read(getResource("kev/boat.png"));
        } catch (IOException e) {
